...
│   │   └── page.tsx               # Main Dashboard with multi-account switcher
│   ├── components/
...
│   │   ├── TransactionTable.tsx   # Searchable, filterable ledger with Source File badges
│   │   └── UploadZone.tsx         # Drag-and-drop file upload handler
│   ├── lib/
│   │   ├── engine/
│   │   │   ├── classifier.ts      # Transaction keywords and category classifier
