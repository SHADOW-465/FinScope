  ...
  return (
    <div className="space-y-4">
      ...
      {integrity && integrity.status !== "ok" && (
        <div
          className={`glass-panel rounded-2xl p-4 border flex items-start gap-3 ${
      ...
      {integrity && integrity.status === "ok" && (
        <div className="glass-panel rounded-2xl p-4 border border-emerald-500/20 bg-emerald-950/5 flex items-center gap-3">
